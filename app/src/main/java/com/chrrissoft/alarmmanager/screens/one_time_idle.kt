...
import com.chrrissoft.alarmmanager.AlarmsEvent.OneTimeIdleAlarmsEvent
import com.chrrissoft.alarmmanager.AlarmsEvent.OneTimeIdleAlarmsEvent.*
import com.chrrissoft.alarmmanager.AlarmsState.OneTimeIdleState
...
@Composable
fun OneTimeIdleAlarmsScreen(
    state: OneTimeIdleState,
    onEvent: (OneTimeIdleAlarmsEvent) -> Unit,
    onOpenDrawer: () -> Unit,
) {
    Scaffold(
        topBar = {
