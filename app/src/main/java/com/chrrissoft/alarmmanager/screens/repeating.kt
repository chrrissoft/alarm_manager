...
import com.chrrissoft.alarmmanager.AlarmsEvent.RepeatingAlarmsEvent
import com.chrrissoft.alarmmanager.AlarmsEvent.RepeatingAlarmsEvent.*
import com.chrrissoft.alarmmanager.AlarmsState
import com.chrrissoft.alarmmanager.AlarmsState.Page.Companion.pages
import com.chrrissoft.alarmmanager.AlarmsState.RepeatingAlarmsState
...
@Composable
fun RepeatingAlarmsScreen(
    state: RepeatingAlarmsState,
    onEvent: (RepeatingAlarmsEvent) -> Unit,
    onOpenDrawer: () -> Unit,
) {
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                title = { TopBarTitle(title = "Repeating Alarms") },
            )
        },
